...
SELECT
    ...
    COUNT_IF(
        VISIT_ID IS NULL
    ) AS NULL_VISIT_ID_ROWS,
    COUNT_IF(
        SUBJECT_ID IS NULL
    ) AS NULL_SUBJECT_ID_ROWS,
    COUNT_IF(
        RECORD_HASH IS NULL
    ) AS NULL_HASH_ROWS
...
MERGE INTO
    ACT_DB.RAW.RAW_VISIT_HISTORY AS T
...
MERGE INTO
    ACT_DB.RAW.RAW_VISIT_CURRENT AS T
