...
--
-- This supports a client correction where STUDY data changes
-- but UPDATED_AT does not change.
-- ============================================================================
...
MERGE INTO
    ACT_DB.RAW.RAW_STUDY_HISTORY AS T
...
MERGE INTO
    ACT_DB.RAW.RAW_STUDY_CURRENT AS T
