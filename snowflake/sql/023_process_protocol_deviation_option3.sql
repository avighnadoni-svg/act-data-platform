-- ============================================================================
-- ACT Data Platform - Process PROTOCOL_DEVIATION Option 3
-- File: snowflake/sql/023_process_protocol_deviation_option3.sql
--
...
-- Replay protection:
--   HISTORY uniqueness =
--       STUDY_ID + DEVIATION_ID + UPDATED_AT + RECORD_HASH
--
-- Current-state rule:
...
-- ============================================================================
-- 1. COPY NEW PROTOCOL_DEVIATION FILES INTO LANDING
-- ============================================================================

COPY INTO ACT_DB.RAW.LND_PROTOCOL_DEVIATION
(
    DEVIATION_ID,
    STUDY_ID,
    SUBJECT_ID,
...
UPDATE ACT_DB.RAW.LND_PROTOCOL_DEVIATION
SET RECORD_HASH =
    SHA2(
        CONCAT_WS(
            '||',
...
SELECT
    ...
    COUNT_IF(DEVIATION_ID IS NULL) AS NULL_DEVIATION_ID_ROWS,
...
MERGE INTO ACT_DB.RAW.RAW_PROTOCOL_DEVIATION_HISTORY AS T
USING
(
    SELECT
        DEVIATION_ID,
...
AND T.DEVIATION_ID = S.DEVIATION_ID
...
MERGE INTO ACT_DB.RAW.RAW_PROTOCOL_DEVIATION_CURRENT AS T
USING
(
    SELECT
        DEVIATION_ID,
...
THEN UPDATE SET
    ...
    T.SITE_ID = S.SITE_ID,
    T.DEVIATION_TYPE = S.DEVIATION_TYPE,
...
SELECT
    ...
    COUNT(DISTINCT DEVIATION_ID) AS DISTINCT_DEVIATIONS
...
WHERE
    SCHEMA_NAME = 'RAW'
    AND TABLE_NAME = 'LND_PROTOCOL_DEVIATION'
