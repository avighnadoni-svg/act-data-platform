-- ============================================================================
-- ACT Data Platform - SUBJECT Option 3 Tables
-- File: snowflake/sql/015_prepare_subject_option3.sql
--
-- Flow:
--
--   S3 subject CSV
...
CREATE TRANSIENT TABLE IF NOT EXISTS LND_SUBJECT
(
...
COMMENT = 'Transient landing table for ACT subject files copied from S3';
...
CREATE TABLE IF NOT EXISTS RAW_SUBJECT_HISTORY
(
    SUBJECT_ID                 VARCHAR,
    STUDY_ID                   VARCHAR,
    SITE_ID                    VARCHAR,
...
COMMENT = 'Unique historical versions of ACT subject records';
...
CREATE TABLE IF NOT EXISTS RAW_SUBJECT_CURRENT
(
    SUBJECT_ID                 VARCHAR,
    STUDY_ID                   VARCHAR,
    SITE_ID                    VARCHAR,
...
COMMENT = 'Current ACT subject state; one row per STUDY_ID + SUBJECT_ID';
...
DESC TABLE LND_SUBJECT;
DESC TABLE RAW_SUBJECT_HISTORY;
DESC TABLE RAW_SUBJECT_CURRENT;
